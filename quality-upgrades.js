(function(){
    ...
    if(details){
        ...
        new MutationObserver(()=>{
            ...
            coach.textContent=accuracy>=90?'COACH TIP · Excellent control. Challenge yourself to react earlier next run.':accuracy>=70?'COACH TIP · Track the lowest matching target before completing the word.':'COACH TIP · Clear a bad prefix early and prioritize words closest to the base.';
